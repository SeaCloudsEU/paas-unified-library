...
public class TunnelServer {
	...
	/**
	 * Returns the local port where the server was binded. 
	 * This method is needed when InectSocketAddress has port 0 (meaning to bind to any available
	 * port).
	 * 
	 * @return local port when server is binded; else -1
	 */
