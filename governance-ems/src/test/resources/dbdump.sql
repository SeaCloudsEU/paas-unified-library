...
CREATE TABLE `breach` (
  ...
  KEY `FK_h7yhsmyi171b0ann992004l6d` (`guarantee_term_id`),
  CONSTRAINT `FK_h7yhsmyi171b0ann992004l6d` FOREIGN KEY (`guarantee_term_id`) REFERENCES `guarantee_term` (`id`),
...
-- Dump completed on 2014-03-26 16:09:42
